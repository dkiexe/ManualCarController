...
- F / Left Shift : Shift Gear UP.
- R / Caps Lock : Shift Gear Down.
- Space : Hand Brake ( use to make the car slide for drifts. )

## Dependencies && Credits
- Cinemachine by Unity for camera logic - com.unity.cinemachine
- Race Car package by Ysn Studio : https://assetstore.unity.com/packages/3d/vehicles/race-car-package-141690
